...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['booking_id']) && isset($_POST['new_status'])) {
    ...
    try {
        ...
        if($b_data) {
            ...
            $google_app_script_url = 'https://script.google.com/macros/s/AKfycbyIWjfaWligW25F2MKfRuJHusoy43bcCIoYLhnjyAxr48vCGfze-bBBNJh-8HnaPpiTYA/exec'; // ⚠️ ILISI KINI SA IMONG SCRIPT URL! ⚠️
