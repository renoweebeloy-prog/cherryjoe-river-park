...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', -apple-system, sans-serif; }
        ...
        .input-group input { width: 100%; padding: 15px 15px 15px 45px; border: 2px solid transparent; background: #f8fafc; border-radius: 14px; font-size: 18px; letter-spacing: 5px; font-weight: bold; color: #1e293b; transition: all 0.3s ease; border: 2px solid #cbd5e1; text-align: center; }
